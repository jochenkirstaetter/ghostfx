...
public class MigrationEngineTests : IDisposable
{
    ...
    public async Task ExecuteAsync_WithoutDrafts_GeneratesOnlyPublishedPosts()
    {
        ...
        string postFile = Path.Combine(_testOutputDir, "migrating-ghost-to-docfx.md");
    ...
    public async Task ExecuteAsync_WithDrafts_GeneratesDraftsInSubfolder()
    {
        ...
        string draftFile = Path.Combine(_testOutputDir, "drafts", "draft-article-dotnet-10.md");
        ...
        string draftTocFile = Path.Combine(_testOutputDir, "drafts", "toc.yml");
