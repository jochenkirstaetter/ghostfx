...
public static class DocfxGenerator
{
        ...
        List<IconLink>? iconLinks = null)
    {
        ...
        string pagesPattern = string.IsNullOrEmpty(relOutputDir) ? "pages/**.md" : $"{relOutputDir}/pages/**.md";
        string scheduledPattern = string.IsNullOrEmpty(relOutputDir) ? "scheduled/**.md" : $"{relOutputDir}/scheduled/**.md";
        ...
        var docfxConfig = new
        {
            build = new
            {
                ...
                globalMetadata = new
                {
                    ...
                    _appLogoPath = logoPath ?? "favicon.ico",
                    _enableSearch = true,
