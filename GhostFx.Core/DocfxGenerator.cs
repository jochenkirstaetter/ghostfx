...
{
    public static async Task<string> GenerateDocfxJsonIfNotExistsAsync(string rootDir, GhostFxConfig config, string customTemplatePath = "templates/ghost-theme")
    {
        ...
        var docfxConfig = new
        {
            build = new
            {
                ...
                globalMetadata = new
                {
                    ...
                    _enableSearch = true,
                    _appFooter = $"<span>Generated by <a href='https://github.com/ghostfx'>GhostFx</a> for DocFx</span>"
                }
            }
        };
